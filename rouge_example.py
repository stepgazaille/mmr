...
summaries = [
    [   # One summary is a list of sentences:
...
references = [
                [   # 3 references for first summary:
                    [
                ...
                [   # 4 references for second summary:
                    [
...
rouge = Pythonrouge(summary=summaries, reference=references,
